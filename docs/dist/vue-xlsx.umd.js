(function(global, factory) {
  ...
  var _iterDefine = function(
    ...
    var $native =
      proto[ITERATOR$2] || proto[FF_ITERATOR] || (DEFAULT && proto[DEFAULT]);
    ...
    if ($anyNative) {
      ...
      if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
        ...
        if (!_library && typeof IteratorPrototype[ITERATOR$2] != "function")
          _hide(IteratorPrototype, ITERATOR$2, returnThis);
      }
    }
    ...
    methods: {
      ...
      deleteSheet: function deleteSheet(sheetName) {
        if (this._workbook && this._workbook.Sheets[sheetName]) {
          this._workbook.SheetNames = this._workbook.SheetNames.filter(function(
            s
          ) {
            return s !== sheetName;
          });
